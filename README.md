...
This API consumes data from the data warehouse defined in:
...
- Access to a SQL Server instance with the data warehouse schema as defined in [SQL Data Warehouse](https://github.com/cea123s/sql-data-warehouse)
...
The API queries two tables in the data warehouse as defined in [SQL Data Warehouse](https://github.com/cea123s/sql-data-warehouse):
